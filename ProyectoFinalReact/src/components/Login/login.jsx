...
import { getData, postDataApplicationJson } from "../../shared/server.jsx";
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { response, result } = await postDataApplicationJson('http://localhost:3001/api/auth/login', loginUser);
